...
if __name__ == '__main__':
    ...
    backbone = darknet53()
    darknet = FPN(backbone.get_last_output_channels(), len(mask) * (5 + classes), backbone).cuda()
